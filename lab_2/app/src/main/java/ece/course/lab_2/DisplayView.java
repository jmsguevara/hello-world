    ...
    public void onDraw(Canvas canvas) {
        ...
        switch(mPtrType) {
            case TYPE_BALL :
                ...
                break;
            case TYPE_SQUARE :
                canvas.drawRect(mPtrCenterX - mPtrRadius, mPtrCenterY - mPtrRadius, mPtrCenterX + mPtrRadius, mPtrCenterY + mPtrRadius, paint);
                break;
            case TYPE_DIAMOND :
                Path path = new Path();
                ...
                break;
            case TYPE_ARC :
                canvas.drawArc(new RectF(mPtrCenterX - mPtrRadius, mPtrCenterY - mPtrRadius, mPtrCenterX + mPtrRadius, mPtrCenterY + mPtrRadius), -45.0f, -90.0f, true, paint);
                break;
        }
